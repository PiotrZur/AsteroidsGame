 ...
 */
public class JFXClassRunner extends BlockJUnit4ClassRunner {
    /**
     * Constructs a new JFXClassRunner with the given parameters.
     *
    ...
    protected void runChild(final FrameworkMethod method, final RunNotifier notifier) {
        ...
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                ...
                JFXClassRunner.super.runChild(method, notifier);
